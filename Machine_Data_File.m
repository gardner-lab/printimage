...
beamDaqs(1).displayNames = {'ConOptics'};  % Optional string cell array of identifiers for each beam
...
beamDaqs(1).referenceClockRate = 1e+08;
...
motorCOMPort = 2;                  % Integer identifying COM port for controller, if using serial communication
